...
import {
    ...
    FormControl,
    InputLabel,
    MenuItem, outlinedInputClasses, Pagination,
    Select,
    SelectChangeEvent,
    TextField,
...
const options = ['2023','2024','2025','2026','2027','2028','2029','2030'];
...
const PassageMng = () => {
    ...
    const rows = [
        { id: 1, year: '2020', name: '수능특강 Light 영어독해',chapter:'18강', count: 8, num:11 },
        { id: 2, year: '2023', name: '수능특강 Light 영어독해',chapter:'17강', count: 10, num:11 },
        { id: 3, year: '2020', name: '올림포스1',chapter:'Test1', count: 12, num:11 },
        { id: 4, year: '2022', name: '올림포스 연합기출',chapter:'Test2', count: 35, num:11 },
    ...
    return (
        <Layout main={true}>
            ...
            <Typography variant='h2' sx={{fontWeight:'500', color:'#ff8b2c', paddingBottom:'20px'}}>
                지문관리
            </Typography>
            <Box sx={{ width: '100%' }}>
                <Box sx={{width:'100%', paddingBottom:'20px'}} >
                    ...
                    <FormControl sx={{width:'580px', marginLeft:'20px'}}>
                        <ThemeProvider theme={customTheme(outerTheme)}>
                            <TextField id="outlined-basic" label="교재명" variant="outlined"/>
                        </ThemeProvider>
                    </FormControl>
