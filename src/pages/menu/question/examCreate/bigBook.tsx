      ...
      <>
        {isDone ? (
          pagePerQuestion.map(({ pageCount, questionIds }, index0) => (
            <div
              className={
                pageCount == 1 ? "div_paper big_first" : "div_paper big_second"
              }
              ref={pageRef}
              key={index0}
            >
              {pageCount == 1 ? (
                <Grid container className="bigHeader">
                  ...
                  <Grid item xs={4} className="bigHeader_text">
                    {props.header}
                  </Grid>
                  <Grid item xs={4}>
          ...
          <div
            className={
              pageSeq == 1 ? "div_paper big_first" : "div_paper big_second"
            }
            ref={pageRef}
          >
            {pageSeq == 1 ? (
                                  ...
                                  from={
                                    props.page == "manage"
                                      ? question[0].passageYear +
                                        " " +
                                        question[0].passageName +
                                        " " +
                                        question[0].passageUnit +
                                        " " +
                                        question[0].passageNumber
                                      : passageYear +
                                        " " +
                                        passageName +
                                        " " +
