  ...
  return (
    <div className="pdf_container" ref={props.pdfRef} id="pdf_container">
      <>
          ...
          pagePerQuestion.map(({ pageCount, questionIds }, index0) => (
            ...
            >
                  ...
                  >
                    <ul style={{ paddingLeft: 20 }}>
                      <li style={{ listStyle: "circle" }}>
                        OMR카드에 학년, 반, 번호, 이름, 과목코드를 정확히
                        기입(표기)하고 해당란에 답을 정확히 표시하시오.
                      </li>
                      <li style={{ listStyle: "circle" }}>
                        [ ] 안의 숫자는 문항 당 배점입니다. 문항에 따라 배점이
                        다르니, 각 물음의 끝에 표시된 배점을 참고하시오.
                      </li>
                      <li style={{ listStyle: "circle" }}>
                          ...
                          if (questionArr[num].question.length == 1) {
                            ...
                            return (
                              <NormalType
                                ...
                                questionContent={
                                  questionArr[num].questionContent
                                }
                                type={"normal"}
                                from={
                                  props.page == "manage"
                                    ? questionArr[num].question[0].passageYear +
                                      " " +
                                      questionArr[num].question[0].passageName +
                                      " " +
                                      questionArr[num].question[0].passageUnit +
                                      " " +
                                      questionArr[num].question[0].passageNumber
                                    : questionArr[num].passageYear +
                                      " " +
                                      questionArr[num].passageName +
                                      " " +
                                      questionArr[num].passageUnit +
                                      " " +
                                      questionArr[num].passageNumber
                                }
                              />
                            );
                          } else {
              ...
              >
                ...
                >
                  이 시험문제의 저작권은 너희가꽃이다 학원에 있습니다.
                  저작권법에 의해 보호받는 저작물이므로 판매와 복제는 금지되여.
                  이를 어길시 저작권법에 의거 처벌될 수 있습니다.
                </div>
              </div>
            </div>
          ))
          ...
          >
                            ...
                            if (question.length == 1) {
                              ...
                              return (
                                <NormalType
                                  ...
                                  from={
                                    props.page == "manage"
                                      ? question[0].passageYear +
                                        " " +
                                        question[0].passageUnit +
                                        " " +
                                        passageNumber
                                      : passageYear +
                                        " " +
            ...
            >
              ...
              <div
                ...
                style={{ fontSize: 9.4, border: "1px solid" }}
              >
                이 시험문제의 저작권은 너희가꽃이다 학원에 있습니다. 저작권법에
                의해 보호받는 저작물이므로 판매와 복제는 금지되여. 이를 어길시
                저작권법에 의거 처벌될 수 있습니다.
              </div>
            </div>
          </div>
        ...
        <div
          className="div_paper big_answer"
          style={{ padding: "7.7% 9.5% 2.3% 9.5%" }}
        >
          <div className="big_answer_head">[Answers] {props.examTitle}</div>
          <div
            className="bigCont"
            style={{
              padding: "20px 0",
