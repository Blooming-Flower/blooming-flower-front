...
const HeaderPc = () => {
	...
	const menuPath: string[] = [PATH.QUESTION0, PATH.QUESTION1, PATH.QUESTION2, PATH.QUESTION3, PATH.QUESTION4, PATH.QUESTION5]
	...
	return (
		<header>
			{/* 메인메뉴 */}
			<div id="headerTopWrap" className="top header2" style={{ backgroundColor: 'rgba(255,247,226,0.9)' }}>
				<Link to="/">
